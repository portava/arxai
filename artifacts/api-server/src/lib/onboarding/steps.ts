...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  { step_id: "readiness-check", title: "Run a Readiness Check", description: "The Readiness Gate scores your system on 6 areas. PASS or PASS_WITH_WARNINGS means you may paper-test.", page_route: "/readiness-checklist", target_component: "ReadinessRunner", action_type: "CLICK", required: true, completion_condition: "Readiness Gate report exists.", help_text: "If readiness BLOCKS, fix the listed items. Passing readiness never by itself enables live trading — that stays operator/admin-gated.", safety_note: SAFETY },
