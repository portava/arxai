...
export async function voiceChatStream(
  ...
  voice: "alloy" | "echo" | "fable" | "onyx" | "nova" | "shimmer" = "alloy",
  inputFormat: "wav" | "mp3" = "wav",
  // Phase 22H — optional prior conversation context. Plain text turns
  // (system / user / assistant) prepended before the new audio input so
  // gpt-audio replies with full memory of the thread. Backward
  // compatible: callers that omit this still get a one-shot turn.
