...
The real live path is `lib/live/liveCommandPipeline.ts` (23-gate). No repair needed; see D2 for the stale-sentinel drift these create on reporting surfaces.
