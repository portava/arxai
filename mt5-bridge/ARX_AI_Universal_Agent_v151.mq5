...
#property strict
#property description "ARX AI Universal MT5 Agent v1.51 — universal command engine, symbol discovery, structured errors, validate-only, broker candle-history producer (safe defaults)."
...
string        EA_VERSION        = "1.51";
string        EA_NAME           = "ARX_AI_Universal_Agent";
string        EA_BUILD          = "1510";
...
int OnInit()
{
   ...
   if(StringLen(BridgeBaseUrl) == 0 || StringLen(BridgeToken) == 0)
      Print("ARX Universal Agent v1.51 — BridgeBaseUrl or BridgeToken missing; EA will idle.");
   EventSetTimer(1);
