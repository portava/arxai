...
2. Environment and rollout phase
3. Owner/admin approval
4. Connection/account status and trading permission
5. Manual confirmation or automated authorization
6. Fresh reconciliation
7. Market-data freshness and source quality
8. Signal age
9. Instrument and capability support
10. Trading session and market state
11. Quantity, precision, minimum and maximum constraints
12. Price collars and slippage
13. Buying power/margin
14. Per-trade risk
15. Aggregate open risk
16. Correlated exposure
17. Daily loss and rolling drawdown
18. Per-symbol/per-edge circuit breakers
19. Execution-failure/latency breaker
20. Idempotency and duplicate-intent check
